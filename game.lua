...
function Game.loadResources()
  ...
  tp:addAnimationSequence({["walk_downright"] = {frames = {2}, framerate = 0}})
  tp:addAnimationSequence({["walk_downleft"] = {frames = {4}, framerate = 0}})
  tp:addAnimationSequence({["walk_upright"] = {frames = {6}, framerate = 0}})
